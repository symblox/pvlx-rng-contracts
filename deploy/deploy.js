...
const { contractManager, chainName } = require('../js-utils/deployHelpers')
...
module.exports = async buidler => {
  ...
  const { vrfCoordinator, linkToken } = await getNamedAccounts()

  const { fee, keyHash } = VDFConfig
  ...
  debug('\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
  debug('PVLX RNG Service - Contract Deploy Script')
  debug('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n')
